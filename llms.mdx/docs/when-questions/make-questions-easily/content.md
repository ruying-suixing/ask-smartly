# 使问题容易回复 (/docs/when-questions/make-questions-easily)
...
## 不要把回复成本转嫁给别人 [#不要把回复成本转嫁给别人]

回答者愿意花时间思考你的问题，已经是在帮你。不要再要求他们绕过正常讨论渠道、复制到私人地址、单独通知你，或者用额外步骤满足你的收信习惯。

如果你需要邮件提醒，请配置自己的客户端或论坛通知，而不是让每个回复者替你处理。

## 论坛里不要要求邮件回复 [#论坛里不要要求邮件回复]
...
问题在哪里公开提出，答案通常也应该在哪里公开留下。这样才能让后来的人搜索、引用和补充。
