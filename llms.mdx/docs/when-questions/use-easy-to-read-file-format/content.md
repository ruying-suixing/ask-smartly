# 使用标准的文件格式发送问题 (/docs/when-questions/use-easy-to-read-file-format)



如果你人为地将问题搞得难以阅读，它多半会被忽略，人们更愿读易懂的问题，所以：

## 让正文容易阅读和引用 [#让正文容易阅读和引用]
...
## 归根结底：降低阅读成本 [#归根结底降低阅读成本]

格式不是小事。可复制的文本、原样保留的日志、清楚的换行和开放格式，都会让别人更容易引用、测试和回复你的问题。你让问题越容易处理，别人越可能愿意处理。
